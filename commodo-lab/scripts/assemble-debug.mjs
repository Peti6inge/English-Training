...
const sdk = findSdk();
if (!sdk) {
  console.error("SDK Android introuvable. Installez Android Studio puis relancez npm run build:apk");
  process.exit(1);
}

writeFileSync(join(androidDir, "local.properties"), `sdk.dir=${sdk.replace(/\\/g, "\\\\").replace(/:/, "\\:")}\n`);
console.log(`SDK: ${sdk}`);
